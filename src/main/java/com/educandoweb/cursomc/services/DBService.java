...
public class DBService {
	...
	public void instatiateTestDatabase() throws ParseException {
		 ...
		 */
		Cliente cli1 = new Cliente(null, "Maria Silva", "marcosfs.guilherme@gmail.com", "33344455545", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		cli1.getEnderecos().addAll(Arrays.asList(e1,e2));
		
		Cliente cli2 = new Cliente(null, "Tony Stark", "mfg_gdm@hotmail.com", "11144455999", TipoCliente.PESSOAJURIDICA, pe.encode("123"));
